...
可以发现，在$\Delta x$较大的时候，$log_2\epsilon(2)$与$log_2\Delta x$成线性关系，斜率大约为2，而当$\Delta x$较小的时候，不再成线性关系，但是总体趋势还是随着网格间距减小而精度增加。，推测可能的原因为此时由于网格大小带来的误差已经非常小，远不及由于浮点数运算精度带来的误差。
